...
title_train.to_csv('xmc/title/train.tsv', sep='\t', index=0)
title_test.to_csv('xmc/title/test.tsv', sep='\t', index=0)
# 描述文本数据集
desc_train, desc_test = train_corpus[['label', 'desc']], test_corpus[['label', 'desc']]
desc_train.to_csv('xmc/desc/train.tsv', sep='\t', index=0)
desc_test.to_csv('xmc/desc/test.tsv', sep='\t', index=0)
# 标题——描述文本数据集
tile_desc_train, tile_desc_test = train_corpus[['label', 'title', 'desc']], test_corpus[['label', 'title', 'desc']]
tile_desc_train.to_csv('xmc/title_desc/train.tsv', sep='\t', index=0)
tile_desc_test.to_csv('xmc/title_desc/test.tsv', sep='\t', index=0)
